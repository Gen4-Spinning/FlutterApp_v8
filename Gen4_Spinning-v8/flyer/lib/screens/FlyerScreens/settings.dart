...
class _FlyerSettingsPageState extends State<FlyerSettingsPage> {
  ...
  String calculate(){
    ...
    double frRollerToMotorGearRatio = 3.33;

    var maxRPM = 1450;
    var strokeDistLimit = 5.1;
    
    var flyerMotorRPM = double.parse(_spindleSpeed.text) * 1;
    ...
    var brMotorRpm = ((frRpm * 22.642) / (double.parse(_draft.text)/ 1.5));
    ...
    var bobbinMotorRPM = bobbinRPM * 1;
    ...
    var liftMotorRPM = (strokeDistPerSec * 60.0 / 4) * 9.0;
