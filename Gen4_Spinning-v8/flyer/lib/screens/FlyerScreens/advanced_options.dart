    ...
    try{
      if(_RTFval!=null){
        ...
        if(_rtfdata > settingsLimits["RTF"]![1]){
          ...
          Provider.of<FlyerConnectionProvider>(context,listen: false).setRTF(_rtfdata.toStringAsFixed(3));
          _RTFval = _rtfdata.toStringAsFixed(3);
          setState(() {
