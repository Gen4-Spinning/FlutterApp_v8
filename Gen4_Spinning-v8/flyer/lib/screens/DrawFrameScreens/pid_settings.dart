...
import '../../message/DrawFrame/DfPID_Settings.dart';
import '../../message/DrawFrame/enums.dart';
import '../../message/acknowledgement.dart';
import '../../services/snackbar_service.dart';
import '../../message/DrawFrame/settingsMessage.dart';


class DfPIDSettings extends StatefulWidget {

  BluetoothConnection connection;
  Stream<Uint8List> settingsStream;
  DfPIDSettings({super.key, required this.connection, required this.settingsStream});

  @override
  _PidSettingsDFState createState() => _PidSettingsDFState();
}


class _PidSettingsDFState extends State<DfPIDSettings> {
